...
fun NutrientCard(
    ...
    Surface(
        ...
        Column(
            ...
            Text(text = name, modifier = Modifier.padding( top=8.dp, bottom = 4.dp, start = 4.dp, end = 4.dp))
            Text(text = info, modifier = Modifier.padding( top=4.dp, bottom = 8.dp, start = 4.dp, end = 4.dp))
            Text(text = amount.toString(), modifier = Modifier.padding( top=4.dp, bottom = 8.dp, start = 4.dp, end = 4.dp))
        }
    }
}
